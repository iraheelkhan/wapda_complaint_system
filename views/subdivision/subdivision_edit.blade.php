...
<div class="row">
        ...
        <div class="col-md-8 grid-margin stretch-card">
          ...
          <form id="my_form" action="{{route('SubDivisionUpdate')}}" method="POST">
                    {{csrf_field()}}
                    <input type="hidden" name="id" value="{{$data->id}}">
                    <div class="form-group">
                      <label>Sub Division Name</label>
                       <input id="subdivision_name" class="form-control input-lg" name="subdivision_name" type="text" placeholder="complaint_title" value="{{$data->subdivision_name}}">
                    ...
                    <div class="form-group">
                      ...
                      <input id="subdivision_code" class="form-control input-lg" name="subdivision_code" type="text" placeholder="Enter your Code" value="{{$data->subdivision_code}}">
